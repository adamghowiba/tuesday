...
interface WorkMangementIconProps {
  size?: number;
}

const WorkMangementIcon: FC<WorkMangementIconProps> = ({size = 30}) => {
  return (
    <>
      <svg
        width="29"
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="1" stopColor="#C2C2FF" />
          </linearGradient>
        </defs>
      </svg>
...
export default WorkMangementIcon;
